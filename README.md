...
*   **Consensus Indicators**:
    *   🟪 **Purple**: Elite Consensus. Triggered if the count of **Elite Whales** meets or exceeds the configured **Elite Threshold**.
...
*   **Visuals**: Set your custom **Elite Consensus Threshold** (e.g., show Purple bar only if >= 3 Elite whales).
